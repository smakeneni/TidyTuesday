...
injuries_plot <- injuries_plot %>% layout(title="Total Brain Injuries by mechanism") %>% layout(yaxis=list(title="")) %>% layout(xaxis=list(title=""))
injuries_plot
```
...
deaths_plot <- deaths_plot %>% layout(title= "Total deaths from brain injuries by mechanism") %>% layout(yaxis=list(title="")) %>% layout(xaxis=list(title=""))
deaths_plot
```
